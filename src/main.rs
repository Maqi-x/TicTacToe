...
pub use crate::bot::{bot::*, level1::*, level2::*, level3::*};

use crossterm::{cursor, queue, terminal as term};
...
fn main() {
    ...
    loop {
        ...
        .unwrap();
        let mut game = TicTacToe::new(playerController);

        game.registerBot(Bot::new(
            idioticBot,
        ...
        let inp = Select::new(
            ...
            vec!["Play again", "Change difficulty level", "Quit"],
        )
        .prompt()
        .expect("Error");
        match inp {
